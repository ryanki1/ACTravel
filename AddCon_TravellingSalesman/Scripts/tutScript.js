...
window.tut = {
    ...
    maps: {
        ...
        initialize: function (cb) {
            var initSrc = "http://maps.google.com/maps/api/js?sensor=true&callback=";
            var cbTut = "tut.maps.ready";
            a= function(d, f) {
        ...
        ready: function (userCoords) {
            ...
            else if (this.wasInvoked && this.map_canvas()) return this.drawRoute(userCoords);
        },
        route: function () {
            var a = localStorage;
        ...
        drawRoute: function (userCoords) {
            ...
            var a = new google.maps.DirectionsRenderer,
                ...
                d;
                if (userCoords){
                    d = new google.maps.LatLng(userCoords[0], userCoords[1]);
                }
                else{
